...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    it('should create a new user successfully', async () => {
      ...
      const createdUser = { ...userData, id: 1, toJSON: () => ({ ...userData, id: 1 }) };
      ...
      expect(result).toEqual(expect.objectContaining({ id: 1, username: userData.username }));
    ...
    it('should throw an error if username already exists', async () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith(expect.stringContaining('Username existinguser already exists.'));
    });
  });
  ...
  describe('getUserById', () => {
    it('should return a user by ID', async () => {
      const user = { id: 1, username: 'testuser', toJSON: () => ({ id: 1, username: 'testuser' }) };
    ...
    it('should return null if user not found', async () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith(expect.stringContaining('User with ID 999 not found.'));
    });
  });
