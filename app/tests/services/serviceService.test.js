...
describe('ServiceService', () => {
  ...
  describe('createService', () => {
    it('should create a service successfully', async () => {
      const serviceData = { name: 'Facial', description: 'A nice facial', duration_minutes: 60, price: 150000 };
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(expect.stringContaining('created successfully'));
    });
  });
  ...
  describe('getServiceById', () => {
    ...
    it('should return null if service not found', async () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith('Service with ID 999 not found.');
    });
  });
  ...
  describe('updateService', () => {
    it('should update a service successfully', async () => {
      ...
      const result = await serviceService.updateService(1, { name: 'Updated Facial' });

      expect(mockServiceRepository.update).toHaveBeenCalledWith(1, { name: 'Updated Facial' });
    ...
    it('should throw a 404 error if service to update is not found', async () => {
      ...
      await expect(serviceService.updateService(999, { name: 'Fail' })).rejects.toThrow('Service not found');
    });
  });
